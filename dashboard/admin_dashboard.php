...
// Fetch staff info
$admin_sql = "
    SELECT a.id, a.user_id, a.name, a.email, a.phone, a.created_at, a.photo 
    FROM admin a 
                ...
                <div class="dashboard-container">
                    <div class="profile-card">
                        ...
                        <div class="profile-header">
                            <img src="../Uploads/<?= !empty($admin_data['photo']) ? $staff_data['photo'] : 'profile_picture.jpeg' ?>" alt="Profile Picture" style="width:100px; height:100px; border-radius:50%;">
                            <h2>HELLO!!! <br><?= $admin_data['name'] ?></h2>
                            <p>Email: <?= $admin_data['email'] ?></p>
                            <p>Phone: <?= $admin_data['phone'] ?></p>
                            <p>Member Since: <?= date('F j, Y', strtotime($admin_data['created_at'])) ?></p>
                        </div>
                    </div>
                </div>
            </main>
