...
checkRole(['admin', 'staff']); // both can view

$sql = "SELECT fines.*, members.name FROM fines 
...
<body>
    <div id="wrapper" class="with-sidebar">
        ...
        <main class="content p-4">
            <h2>Fines List</h2>
            <a href="add_fine.php">Add New Fine</a>
            <br><br>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!$row['paid']) : ?>
                                    <a href="update_fine.php?id=<?= $row['id'] ?>">Mark as Paid</a> |
                                <?php endif; ?>
                                <a href="delete_fine.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure?')">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
